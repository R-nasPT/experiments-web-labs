...
export default function FormInsert() {
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<HeroCharacterFormData>({ mode: "all" });
    ...
    <Fragment>
      <div className="min-h-screen flex flex-col justify-center items-center">
        ...
        <main>
          ...
          <section className="bg-gradient-to-r from-red-500 from-10% via-blue-500 via-30% to-yellow-500 to-90% opacity-70 rounded-2xl">
            <article className="bg-black opacity-70 rounded-2xl">
              ...
              >
                ...
                <div className="flex justify-center gap-20 pl-3">
                  <button
                    className="text-green-200 bg-green-700 hover:bg-green-800 py-3 px-7 rounded-lg"
                    type="submit"
                  >
                    Submit
                  </button>
                  <button
                    className="text-white bg-slate-500 hover:bg-slate-600 py-3 px-7 rounded-lg"
                    type="reset"
                  >
                    Reset Standard
                  </button>
                  <button
                    ...
                    onClick={() => reset({
                      ...
                      age: 32,
                      status: true,
                      appearance: { height: 186, weight: 90 },
                      universe: "DC"
                    })}
                  >
                    Custom Reset
